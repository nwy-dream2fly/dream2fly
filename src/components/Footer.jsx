...
import RedLogo from "../assets/images/dream2fly logo horizontal (red) 2.png";
...
const Footer = () => {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center items-center gap-4 max-w-xl mx-auto">
            ...
            />
            <button className="bg-[#ef6565] text-white px-6 py-1 rounded-full hover:bg-[#e63f3f]">
              Subscribe Now
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-10 border-t border-gray-300">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <img src={RedLogo} alt="Dream2Fly Logo" className="h-12 w-auto" />
            </div>
            <p className="text-lg">
              Fly beyond boundaries. Experience the world the way you’ve always
              dreamed.
            </p>
            <div className="flex gap-4 mt-4 text-[#fff] text-2xl">
              <a
          ...
          <div>
            ...
            <p className="mb-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[#e63f3f] transition"
              >
  ...
  <div className="grid grid-cols-3 gap-2">
    {images.map((img, i) => (
      <div key={i} className="w-full h-20 bg-gray-200 rounded-md overflow-hidden">
        <img src={img} alt={`Insta ${i + 1}`} className="w-full h-full object-cover" />
      </div>
    ))}
  </div>
</div>
        ...
        <div className="border-t py-4 text-sm flex flex-col md:flex-row items-center justify-between text-center text-white-600">
          <p>© 2025 Dream2fly. All Rights Reserved.</p>
          <div className="flex items-center gap-3 mt-2 md:mt-0">
            <span>We Accept</span>
            <img src={VisaIcon} alt="Visa" className="h-14" />
            <img src={MastercardIcon} alt="Mastercard" className="h-14" />
            <img src={PaypalIcon} alt="Paypal" className="h-14" />
